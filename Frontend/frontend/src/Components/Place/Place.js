                    ...
                    <section>
                        {photos?.map((photo,i) => {
                            if(i === photos.length-1){
                                return (
                                    <div style={{backgroundColor:"grey", backgroundImage : `url(https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Plus_symbol.svg/1200px-Plus_symbol.svg.png)`}} className={`box box-${i}`}></div>
                                )
                            }else{
                                return (
